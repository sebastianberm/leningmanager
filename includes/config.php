...
// Applicatie naam (zichtbaar in PDF header). Kan overschreven worden via env.
@define('APP_NAME', getenv('APP_NAME') ?: 'Leningmanager');

// Leningverstrekker opties en adressen (kunnen via docker-compose env variabelen gezet worden)
@define('LENDER_COMPANY_NAME', getenv('LENDER_COMPANY_NAME') ?: 'Sebsoft Holding BV');
@define('LENDER_COMPANY_ADDRESS', getenv('LENDER_COMPANY_ADDRESS') ?: '');

@define('LENDER_PRIVATE_NAME', getenv('LENDER_PRIVATE_NAME') ?: 'Sebastian R. Berm');
